"""Intake Agent assembly — partial dependency injection."""
from functools import partial
from ..graphs.intake import create_graph
from ..states.legal_drafting import LegalDraftingState
from ..prompts.intake import INTAKE_SYSTEM_PROMPT
from ..tools.intake import BACKEND_TOOLS, BACKEND_TOOL_NAMES
from ..nodes.intake import call_model_node
