"""
LangGraph workflow structure for Segmentation Agent.
...
def create_graph(state_class, call_model_node_func, tools):
    """
    Create the segmentation agent workflow graph.

    Args:
        state_class: SegmentationAgentState class
    ...
    """
    logger.info("Creating segmentation agent graph structure...")
    ...
    logger.info("Segmentation agent graph created successfully")
    return graph
