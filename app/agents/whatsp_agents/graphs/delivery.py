"""
LangGraph workflow structure for Delivery Agent.
...
def create_graph(state_class, call_model_node_func, tools):
    """
    Create the delivery agent workflow graph.

    Args:
        state_class: DeliveryAgentState class
    ...
    """
    logger.info("Creating delivery agent graph structure...")
    ...
    logger.info("Delivery agent graph created successfully")
    return graph
